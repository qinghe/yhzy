...
KE.lang = {
	accessory : '插入附件',//TODO wangshizhe
	invalidAccessory : "请输入有效的URL地址。\n只允许doc,xls,pdf,txt,ppt,rar,zip格式。",//TODO wangshizhe
...
KE.setting = {
	...
	items : [
		...
		'italic', 'underline', 'strikethrough', 'removeformat', 'image','accessory',//#TODO accessorg
...
KE.plugin['accessory'] = {
	  ...
	  {
	  case "doc":
	   img="./lib/kindeditor/skins/ico/doc.jpg";
	  break;
	  case "xls":
	   img="./lib/kindeditor/skins/ico/xsl.jpg";
	  break;
	  case "ppt":
	   img="./lib/kindeditor/skins/ico/ppt.jpg";
	  break;
	  case "rar":
	   img="./lib/kindeditor/skins/ico/rar.jpg";
	  break;
	  case "zip":
	   img="./lib/kindeditor/skins/ico/rar.jpg";
	  break;
	  case "txt":
	   img="./lib/kindeditor/skins/ico/other.jpg";
	  break;
	  case "pdf":
	   img="./lib/kindeditor/skins/ico/other.jpg";
	  break;
